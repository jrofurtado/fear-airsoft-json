...
public class JsonServletTempoTest extends TestCase {
    ...
    public void testGetTempoFromCache() {
        assertNull(servlet.getTempoFromCache("37.77", "-25.58", "2013-02-19",
                cache));
        Weather result = servlet.getTempo("37.77", "-25.58", "2013-02-19");
    ...
    public void testParseTempoDataFound() {
        Weather weather = servlet.parseTempoData(jsonTempoRest, "2013-02-19");
    ...
    public void testParseTempoDataNotFound() {
        Weather weather = servlet.parseTempoData(jsonTempoRest, "2013-02-18");
        assertNull(weather);
    }

    public void testTempoParse() {
        Tempo tempo = servlet.parse(jsonRest);
